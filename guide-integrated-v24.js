...
(() => {
  ...
  const data={
    ...
    elbow:[
      {re:/6\.\s*Intra-articular elbow injection/i,text:['Keep the elbow flexed to about 90° for landmark approaches.','Posterior entry uses the midline depression between the two halves of the triceps tendon, directed perpendicular to the skin into the olecranon fossa.','A lateral radiocapitellar entry is just proximal to the radial head, with the needle passed perpendicular to the skin between radial head and capitellum.'],imgs:['images/elbow-joint-posterior-injection-diagram.jpg','Posterior elbow joint landmark approach','images/elbow-joint-posterior-injection-clinical.jpg','Clinical posterior elbow joint positioning','images/elbow-joint-lateral-injection-diagram.jpg','Lateral radiocapitellar landmark approach','images/elbow-joint-lateral-injection-clinical.jpg','Clinical lateral elbow joint positioning']},
      {re:/9\.\s*Olecranon bursa/i,text:['Use a lateral entry through normal skin and aim toward the centre of the bursa.','Avoid the bursal apex/tip because a persistent leaking puncture may provide a route for infection; avoid medial entry because of the ulnar nerve.']}
    ],
    shoulder:[
